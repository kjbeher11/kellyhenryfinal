...
app = dash.Dash(__name__,external_stylesheets=[dbc.themes.MORPH,"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"],suppress_callback_exceptions=True)
